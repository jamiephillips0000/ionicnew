...
/**
 * Generated class for the MathteacherParentPage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-mathteacher-parent',
  templateUrl: 'mathteacher-parent.html',
})
export class MathteacherParentPage {

  constructor(public navCtrl: NavController, public navParams: NavParams) {
  }

  ionViewDidLoad() {
    console.log('ionViewDidLoad MathteacherParentPage');
  }
   /*gotoprivacy(){
