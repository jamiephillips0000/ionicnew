...
/**
 * Generated class for the StudentprofileParentPage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-studentprofile-parent',
  templateUrl: 'studentprofile-parent.html',
})
export class StudentprofileParentPage {
