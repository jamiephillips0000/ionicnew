...
import { AddyearsmobPage } from '../addyearsmob/addyearsmob';
...
/**
 * Generated class for the AddyearsPage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-addyears',
  templateUrl: 'addyears.html',
})
export class AddyearsPage {
width : any;
...
carriculumgroupselected:any={};
  ...
  this.width = window.innerWidth;
   ...
   if(this.width<768){
		this.navCtrl.push(AddyearsmobPage);
	}
  
  }

  ionViewDidLoad() {
    console.log('ionViewDidLoad AddyearsPage');
  }
